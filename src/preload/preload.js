...
contextBridge.exposeInMainWorld('arcana', {
  ...
  summoner: {
    ...
    create:           ({ name, appearance })          => ipcRenderer.invoke('summoner:create', { name, appearance }),
    hasFreeGachaUsed: ()                              => ipcRenderer.invoke('summoner:has-free-gacha-used'),
    freeGacha:        ()                              => ipcRenderer.invoke('summoner:free-gacha'),
    setPersonality:   ({ summonerId, personality })   => ipcRenderer.invoke('summoner:set-personality', { summonerId, personality }),
    getStats:         ({ summonerId })                => ipcRenderer.invoke('summoner:get-stats', { summonerId }),
    investStat:       ({ summonerId, statKey })       => ipcRenderer.invoke('summoner:invest-stat', { summonerId, statKey }),
    addExp:           ({ summonerId, amount })        => ipcRenderer.invoke('summoner:add-exp', { summonerId, amount }),
